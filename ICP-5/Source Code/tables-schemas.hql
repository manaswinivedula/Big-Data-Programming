...
! ls /home/cloudera/Downloads/employees/;

-- Now load the data!

LOAD DATA LOCAL INPATH '/home/cloudera/Downloads/employees/employees.txt/' 
INTO TABLE new;
